...
const directorySync_1 = require("./directorySync");
function activate(context) {
    const terminalManager = new terminalManager_1.TerminalManager(context);
    const directorySync = new directorySync_1.DirectorySync(context);
